...
export const handler: APIGatewayProxyHandlerV2 = async (event) => {
    ...
    const { fromAddress, toAddress, amount } = JSON.parse(event.body);
    console.log("Parsed request body:", { fromAddress, toAddress, amount });
...
async function transferTokens(fromAddress, toAddress, amount) {
    ...
    const senderPrivateKey = "PRIVATEKEYHERE";
